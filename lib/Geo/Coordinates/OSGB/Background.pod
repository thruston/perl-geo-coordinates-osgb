...
Later versions includes a `memo-izing' hash to cache the results of the data 
look ups, but this made very little improvement to performance so it was removed.
